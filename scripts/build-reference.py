...
def build(output):
    ...
    assert set(libraries) == set(PACKAGES), "Missing a local library from the documentation plan"
...
Links between them stay within this reference; other dependencies link to Hackage.</p>
